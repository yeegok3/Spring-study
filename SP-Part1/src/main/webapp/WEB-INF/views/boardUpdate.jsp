		...
		<div class="panel panel-default">
			...
			<input type="hidden" name="idx" value="${vo.idx }"/>
				<table class="table">
					...
					<tr>
						<td>내용</td>
						<td><textarea name="content" id="" cols="30" rows="10" class="form-control">${vo.content }</textarea></td>
					</tr>
					<tr>
						<td>작성자</td>
						<td><input type="text" name="writer" value="${vo.writer }" readonly class="form-control"/></td>
					</tr>
					<tr>
